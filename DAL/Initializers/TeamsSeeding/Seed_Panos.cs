...
namespace DAL.Initializers.TeamsSeeding
{
    public class Seed_Panos : ITeamSeeder
    {
        public List<Artist> GetArtists(TeamGenres g)
        {
            ...
            Album pa1album3 = new Album("Dylan & the Dead", new DateTime(1989, 2, 6), "/Content/Assets/entity-files/BobDylan/Dylan_&_the_Dead/cover.jpg", pa1, new HashSet<Genre>() { g.folk, g.rock });
            ...
            Album pa3album2 = new Album("Born this way", new DateTime(2011, 05, 23), "/Content/Assets/entity-files/Lady_Gaga/Born_This_Way/cover.png", pa3, new HashSet<Genre>() { g.pop });
            Album pa3album3 = new Album("Joanne", new DateTime(2016, 10, 21), "/Content/Assets/entity-files/Lady_Gaga/Joanne/cover.png", pa3, new HashSet<Genre>() { g.pop, g.rock, g.country });
        ...
        #region The Wiggles
            ...
            Album pa4album3 = new Album("Serfer Jeff", new DateTime(2012, 5, 3), "/Content/Assets/entity-files/The_Wingles/Serfer_Jeff/cover.jpg", pa4, new HashSet<Genre>() { g.kid });
